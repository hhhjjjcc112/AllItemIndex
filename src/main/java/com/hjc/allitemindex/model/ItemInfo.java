...
public class ItemInfo {
    // 不进行序列化
    public transient ID id = new ID(); // 物品ID
    @SerializedName("en") public String englishName; // 英文名称(非官方?)
    @SerializedName("cn") public String chineseName; // 中文名称(非官方?)
    @SerializedName("alias") public Set<String> chineseAlias; // 中文别称(非官方)
    @SerializedName("carpet") public CarpetColor carpetColor; // 地面地毯颜色
    @SerializedName("direction") public Direction direction; // 方向
    @SerializedName("direction_color") public CarpetColor directionColor; // 对应方向的地毯颜色
    @SerializedName("light") public FloorLight floorLight; // 所在楼层地板的灯光
